                ...
                <div className='w-[350px] h-[85vh] border border-gray-600 bg-[#def1fc]'>
                    ...
                    <table>
                        ...
                        <div className='border border-b-gray-500 w-[347px]'>
                            ...
                            <Link to={"/display"}><p className='ml-[287px] text-[14px] '>Back</p></Link>
                        </div>
                        <tbody>
                            {region.map(reg => (
                                <tr key={reg.regionMasterId}>
                                    <Link to={`/displayRegion/${reg.regionMasterId}`}>
                                        <td className='flex justify-center items-center'>{reg.regionMasterId}</td>
                                    </Link>
                                </tr>
                            ))}
                        </tbody>
