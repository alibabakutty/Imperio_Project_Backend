    ...
    <div>
        <div className='flex'>
                ...
                <div className='w-1/2 border border-bg-gray-500'>
                    ...
                    <div className='w-[550px] h-[20vh] border border-gray-500 ml-[80px] '>
                        <form onSubmit={(e) => {onSubmit(e)}}>
                            ...
                            <div className='input-ldgr mt-1'>
                                ...
                                : <input type="text" id='productDescription' name='productDescription' value={product.productDescription} onChange={(e) =>onInputChange(e)} className='w-[300px] ml-2 h-5 capitalize font-medium pl-1 text-sm focus:bg-yellow-200 focus:border focus:border-blue-500 focus:outline-none'  />
                            </div>
                    ...
                    <div className='mt-[400px] ml-[480px]'>
